...
geoplot(RAD2DEG*GPSdata(1,:),RAD2DEG*GPSdata(2,:),'b+');
...
figure(13), subplot(3,1,1), plot(X(1,:), Y(1,:)), ylim([-10 10]), ylabel('N Error [m]'), title('Integrated Navigation Error', 'FontSize', 18)
figure(13), subplot(3,1,2), plot(X(2,:), Y(2,:)), ylim([-20 25]), ylabel('E Error [m]')
figure(13), subplot(3,1,3), plot(X(3,:), Y(3,:)), ylim([0 30]), xlabel('Time [sec]'), ylabel('Distance Error [m]')
%==================================
...
figure(100), subplot(2,1,1), plot(X(3,:), Y(3,:), 'b', X(3,idx), Y(3,idx), 'rx'), grid on, xlabel('time [sec]'), ylabel('filter error distance [m]'), ylim([0 30]), title('Navigation Error Distances', 'FontSize', 18)
...
figure(12), subplot(3,1,1), plot(X(1,:), Y(1,:)), ylim([-50 50]), ylabel('N Error [m]'), title('Pure Inertial Navigation Error', 'FontSize', 18)
figure(12), subplot(3,1,2), plot(X(2,:), Y(2,:)), ylim([-100 50]), ylabel('E Error [m]')
figure(12), subplot(3,1,3), plot(X(3,:), Y(3,:)), ylim([0 70]), xlabel('Time [sec]'), ylabel('Distance Error [m]')
%==================================

figure(100), hold on, subplot(2,1,2), plot(X(3,:), Y(3,:), 'b', X(3,idx), Y(3,idx), 'rx'), grid on, xlabel('time [sec]'), ylabel('IN error distance [m]'), ylim([0 80]),
